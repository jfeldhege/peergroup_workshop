...
To turn a Quarto document into its output, it needs to be rendered.

This can be down using RStudio buttons:
...
I have created an example Quarto document [here](https://github.com/jfeldhege/peergroup_workshop/blob/main/examples/quarto_example.qmd)
